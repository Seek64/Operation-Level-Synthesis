...
architecture behav of getEncUALUresult is 
    ...
    signal p_s_getImmediate_fu_54_ap_ready : STD_LOGIC;
    signal p_s_getImmediate_fu_54_ap_return : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_getInstrType_fu_62_ap_ready : STD_LOGIC;
    signal tmp_getInstrType_fu_62_ap_return : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_s_fu_68_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    p_s_getImmediate_fu_54 : component getImmediate
    port map (
        ap_ready => p_s_getImmediate_fu_54_ap_ready,
        encodedInstr_V => encodedInstr_V,
        ap_return => p_s_getImmediate_fu_54_ap_return);

    tmp_getInstrType_fu_62 : component getInstrType
    port map (
        ap_ready => tmp_getInstrType_fu_62_ap_ready,
        encodedInstr_V => encodedInstr_V,
        ap_return => tmp_getInstrType_fu_62_ap_return);
    ...
    grp_getALUresult_fu_41_aluFunction_assign_proc : process(tmp_s_fu_68_p2)
    begin
        if ((tmp_s_fu_68_p2 = ap_const_lv1_1)) then 
            grp_getALUresult_fu_41_aluFunction <= ap_const_lv4_2;
        elsif ((tmp_s_fu_68_p2 = ap_const_lv1_0)) then 
    ...
    grp_getALUresult_fu_41_operand1_V_assign_proc : process(pcReg_V, p_s_getImmediate_fu_54_ap_return, tmp_s_fu_68_p2)
    begin
        if ((tmp_s_fu_68_p2 = ap_const_lv1_1)) then 
            grp_getALUresult_fu_41_operand1_V <= p_s_getImmediate_fu_54_ap_return;
        elsif ((tmp_s_fu_68_p2 = ap_const_lv1_0)) then 
    ...
    grp_getALUresult_fu_41_operand2_V_assign_proc : process(p_s_getImmediate_fu_54_ap_return, tmp_s_fu_68_p2)
    begin
        if ((tmp_s_fu_68_p2 = ap_const_lv1_1)) then 
            grp_getALUresult_fu_41_operand2_V <= ap_const_lv32_0;
        elsif ((tmp_s_fu_68_p2 = ap_const_lv1_0)) then 
            grp_getALUresult_fu_41_operand2_V <= p_s_getImmediate_fu_54_ap_return;
        else 
            grp_getALUresult_fu_41_operand2_V <= "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
        end if; 
    end process;

    tmp_s_fu_68_p2 <= "1" when (tmp_getInstrType_fu_62_ap_return = ap_const_lv6_11) else "0";
end behav;
