...
architecture behav of ISS_operations is 
    ...
    "ISS_operations,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcvu9p-flga2104-2-i,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.377425,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=161,HLS_SYN_LUT=7265,HLS_VERSION=2020_1}";
    ...
    signal zext_ln321_2_fu_1100_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln321_1_fu_1105_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln321_5_fu_1118_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln321_4_fu_1123_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln321_3_fu_1128_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln321_fu_1133_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, active_operation, ap_CS_fsm_state3, ap_block_state3_on_subcall_done, ap_CS_fsm_state2, ap_CS_fsm_state4, ap_block_state2_on_subcall_done, ap_block_state4_on_subcall_done)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not((ap_const_lv4_7 = active_operation)) and not((ap_const_lv4_3 = active_operation)) and not((ap_const_lv4_2 = active_operation)) and not((ap_const_lv4_9 = active_operation)) and not((ap_const_lv4_8 = active_operation)) and not((ap_const_lv4_4 = active_operation)) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and ((ap_const_lv4_2 = active_operation) or ((ap_const_lv4_3 = active_operation) or (ap_const_lv4_4 = active_operation))))) then
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (ap_const_boolean_0 = ap_block_state3_on_subcall_done) and ((ap_const_lv4_2 = active_operation) or ((ap_const_lv4_3 = active_operation) or (ap_const_lv4_4 = active_operation))))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    out_regfileWrite_dst_V_assign_proc : process(ap_start, ap_CS_fsm_state1, in_regfileWrite_dst_V, active_operation, active_operation_rea_read_fu_206_p2, ap_CS_fsm_state2, ap_CS_fsm_state4, ap_block_state2_on_subcall_done, ap_block_state4_on_subcall_done, zext_ln321_2_fu_1100_p1, zext_ln321_1_fu_1105_p1, zext_ln321_5_fu_1118_p1, zext_ln321_4_fu_1123_p1, zext_ln321_3_fu_1128_p1, zext_ln321_fu_1133_p1)
    begin
        if (((ap_const_lv4_2 = active_operation) and (ap_const_boolean_0 = ap_block_state4_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
            out_regfileWrite_dst_V <= zext_ln321_fu_1133_p1;
            ...
            out_regfileWrite_dst_V <= zext_ln321_3_fu_1128_p1;
            ...
            out_regfileWrite_dst_V <= zext_ln321_4_fu_1123_p1;
            ...
            out_regfileWrite_dst_V <= zext_ln321_5_fu_1118_p1;
        elsif (((ap_start = ap_const_logic_1) and (ap_const_lv4_5 = active_operation_rea_read_fu_206_p2) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            out_regfileWrite_dst_V <= zext_ln321_1_fu_1105_p1;
            ...
            out_regfileWrite_dst_V <= zext_ln321_2_fu_1100_p1;
        elsif (((ap_start = ap_const_logic_1) and (ap_const_lv4_D = active_operation_rea_read_fu_206_p2) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    zext_ln321_1_fu_1105_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
    zext_ln321_2_fu_1100_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
    zext_ln321_3_fu_1128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
    zext_ln321_4_fu_1123_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
    zext_ln321_5_fu_1118_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
    zext_ln321_fu_1133_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(grp_getRdAddr_fu_499_ap_return),32));
end behav;
