...
class ISS : public sc_module {
public:
    //Constructor
    SC_HAS_PROCESS(ISS);

    ISS(sc_module_name name) :
...
EncType ISS::getEncType(unsigned int encodedInstr) const {
...
InstrType ISS::getInstrType(unsigned int encodedInstr) const {
...
ALUfuncType ISS::getALUfunc(InstrType instr) const {
...
ME_MaskType ISS::getMemoryMask(InstrType instr) const {
...
unsigned int ISS::branchPCcalculation(unsigned int encodedInstr, unsigned int aluResult, unsigned int pcReg) const {
...
unsigned int ISS::getEncUALUresult(unsigned int encodedInstr, unsigned int pcReg) const {
