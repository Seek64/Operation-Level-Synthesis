...
assume:
	at t: z_2;
	at t: not(z_sync);
--	at t: done_port_out = 0;	-- el secret hena!!!!!
...
assume:
	at t: x_1;
	at t: x_sync;
--	at t_end: done_port_out = 1;	-- el secret hena!!!!!
--	at t: active_op = 0;		-- it is either this line or the upper two (x_1 and x_sync)
...
--	at t_end: x_notify_vld = true;
--	at t_end: z_notify_vld = true;
